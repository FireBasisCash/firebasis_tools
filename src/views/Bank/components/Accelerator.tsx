...
const Accelerator: React.FC<AcceleratorProps> = ({ bank }) => {
  ...
  // TODO: reactive update of token balance
  const depositStakedBalance = useStakedBalance(bank.contract);
  ...
  const canAccelerate = () => {
    if (bank.finished)
      return false;
    if (depositStakedBalance.isZero() || depositStakedBalance.isNegative())
      return false;
          ...
          <StyledCardActions>
            {approveStatus !== ApprovalState.APPROVED ? (
              ...
              />
                ...
                <>
                  <IconButton onClick={onPresentWithdraw} disabled={stakedBalance.isZero() ? true : false}>
                  ...
                  <IconButton
                    ...
                    onClick={() => (canAccelerate() ? onPresentDeposit() : null)}
                  >
                    <AddIcon />
                  </IconButton>
                  {/* <IconButton
                    disabled={bank.finished || !canAccelerate()}
